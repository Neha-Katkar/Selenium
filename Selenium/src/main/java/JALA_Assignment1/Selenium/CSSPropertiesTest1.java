...
public class CSSPropertiesTest1 {
    ...
    public void testCSSProperties() throws InterruptedException {
        ...
        String alertFontSize = alert.getCssValue("font-size");
        String alertFontStyle = alert.getCssValue("font-style");
        String alertColor = alert.getCssValue("color");
        String text = alert.getText();
        // Print the text to the console
        System.out.println("Text from the green element: " + text);
              
        // Print the CSS properties to the console
        System.out.println("CSS properties of the link:");
        System.out.println("Font size: " + alertFontSize);
        System.out.println("Font style: " + alertFontStyle);
        System.out.println("Color: " + alertColor);
    }
